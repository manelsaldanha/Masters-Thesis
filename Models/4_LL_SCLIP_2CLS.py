...
from HF_SCLIP import CLIPTextModel, CLIPVisionModel, CLIPVisionModelWithProjection, CLIPTextModelWithProjection
import json
import torchvision
...
class Model(nn.Module):
    def __init__(self,hidden_dim=768, nheads=8,
        ...
        print('Vision hidden_dim_in:',self.vit.model.visual_projection.in_features)
        print('Vision hidden_dim_out:',self.vit.model.visual_projection.out_features)

        print('Text hidden_dim_in:',self.text_encoder.model.text_projection.in_features)
        print('Text hidden_dim_out:',self.text_encoder.model.text_projection.out_features)
    ...
    def forward(self, image: torch.Tensor, text: torch.Tensor):
        ...
        special_tokens_masks=torch.full(size=(i.shape[0],2), fill_value=False, dtype=torch.bool).to(device)
        memory_padding_mask=torch.cat((special_tokens_masks, i_padding_mask, t_padding_mask), dim=1)
        
        diff=i_cls['image_embeds']-t_cls['text_embeds']
        multi=i_cls['image_embeds']*t_cls['text_embeds']

        #concat output tokens of CLIPVision and CLIPText
        memory=torch.cat((diff,multi,i, t), dim=1)
...
ann_file = r'/tmp/Toloka_dataset/complete_DS/annotations'
...
#checkpoint=torch.load('/cfs/home/u021542/final_model/4_linear_layers/results/SCLIP_2_CLS/best_model_resize.pt')
...
early_stopping = EarlyStopping(patience=2, verbose=True, path='/cfs/home/u021542/final_model/4_linear_layers/results/SCLIP_2_CLS/best_model_resize.pt')

train_val_path=r'/cfs/home/u021542/final_model/4_linear_layers/results/SCLIP_2_CLS/train_val_results_resize.txt'

train_pred=r'/cfs/home/u021542/final_model/4_linear_layers/results/SCLIP_2_CLS/draw/train_pred_resize.json'
val_pred=r'/cfs/home/u021542/final_model/4_linear_layers/results/SCLIP_2_CLS/draw/val_pred_resize.json'
