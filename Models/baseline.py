...
class Model(nn.Module):
    ...
    def forward(self, image: torch.Tensor, text: torch.Tensor):
        ...
        i_padding_mask=torch.full(size=(i[0].shape[0],i[0].shape[1]), fill_value=False, dtype=torch.bool).to(device)
        ...
        memory=torch.cat((i[0], t[0]), dim=1)
...
early_stopping = EarlyStopping(patience=2, verbose=True, path='/cfs/home/u021542/final_model/results/M_6input_M_loss/best_model_resize.pt')

train_val_path=r'/cfs/home/u021542/final_model/results/M_6input_M_loss/train_val_results_resize.txt'

train_pred=r'/cfs/home/u021542/final_model/results/M_6input_M_loss/draw/train_pred_resize.json'
val_pred=r'/cfs/home/u021542/final_model/results/M_6input_M_loss/draw/val_pred_resize.json'
